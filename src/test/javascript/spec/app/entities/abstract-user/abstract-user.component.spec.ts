...
import { AbstractUserComponent } from 'app/entities/abstract-user/abstract-user.component';
...
describe('Component Tests', () => {
    describe('AbstractUser Management Component', () => {
        let comp: AbstractUserComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AbstractUserComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.abstractUsers[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
